...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <h2 class="h2-judul">Menambahkan Member</h2>
      <p class="lead p-desk">Silakan isi data member yang akan didaftarkan ke database.</p>
    </div>
    ...
    <div class="row g-5">
      <div class="col-md-12 col-lg-12">
        ...
        <form class="needs-validation" novalidate method="post" action="addMember.php">
          ...
          <button class="w-100 btn btn-dark btn-lg" type="submit">Tambahkan member</button>
